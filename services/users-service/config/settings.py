...
def parse_database_url(database_url: str) -> dict[str, str | int]:
    ...
    if parsed.scheme not in {'postgres', 'postgresql'}:
        raise ValueError('Unsupported database URL scheme for users-service.')
...
USERS_DATABASE_URL = os.getenv('USERS_DATABASE_URL') or os.getenv('DATABASE_URL')

if USERS_DATABASE_URL:
    DATABASES = {'default': parse_database_url(USERS_DATABASE_URL)}
else:
    DATABASES = {
        'default': {

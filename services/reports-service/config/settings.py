...
def parse_database_url(database_url: str) -> dict[str, str | int]:
    ...
    if parsed.scheme not in {'postgres', 'postgresql'}:
        raise ValueError('Unsupported database URL scheme for reports-service.')
...
REPORTS_DATABASE_URL = os.getenv('REPORTS_DATABASE_URL') or os.getenv('DATABASE_URL')

if REPORTS_DATABASE_URL:
    DATABASES = {'default': parse_database_url(REPORTS_DATABASE_URL)}
else:
    DATABASES = {
        'default': {
